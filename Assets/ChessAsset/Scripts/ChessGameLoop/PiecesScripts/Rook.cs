...
namespace ChessMainLoop
{
    public class Rook : Piece
    {
        ...
        {
            List<PathPiece> allPaths = PathManager.CreateVerticalPath(this);
        ...
        {
            return PathManager.GetVerticalPathLength(this);
        }

        internal override bool HasSinglePath()
        {
            return PathManager.CheckVerticalPathAtDistance(this, 1);
        }

        internal override bool HasLongPath()
        {
            return PathManager.CheckVerticalPathAtDistance(this, 3);
        }
    }
}